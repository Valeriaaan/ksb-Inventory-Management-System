Public Class SalesForm
    ...
    Private Sub TextBox_TextChangedAndDataGridView_RowsAdded(sender As Object, e As EventArgs) Handles SalesCustomerNameTextBox.TextChanged, SalesDGV.RowsAdded
        If SalesCustomerNameTextBox.Text.Trim() <> "" AndAlso SalesDGV.Rows.Count > 0 Then
            SalesBuyButton.Enabled = True
        Else
            SalesBuyButton.Enabled = False
        End If
    End Sub

    Private Sub SalesFLP_Paint(sender As Object, e As PaintEventArgs) Handles SalesFLP.Paint
